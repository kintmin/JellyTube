...
sealed interface LyricsEditIntent {
    ...
    data class OnChangeTranslation(val rowId: Int, val text: String) : LyricsEditIntent
    data class OnChangeTransliteration(val rowId: Int, val text: String) : LyricsEditIntent
